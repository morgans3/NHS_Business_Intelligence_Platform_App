...
export class AccessLogsChartComponent implements OnInit, AfterViewInit {
    ...
    getStatistics() {
        ...
        // Get stats
        this.apiService
            .getAllAccessLogsStatistics(this.date.from.format("YYYY-MM-DD"), this.date.to.format("YYYY-MM-DD"))
