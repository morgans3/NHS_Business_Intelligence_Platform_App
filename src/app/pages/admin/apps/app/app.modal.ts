...
export class AppModalComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data, private apiService: APIService, private dialogRef: MatDialogRef<AppModalComponent>, private notificationService: NotificationService) {}
