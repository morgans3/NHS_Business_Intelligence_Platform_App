...
export class RequestComponent implements OnInit {
    ...
    requestConfig = { 
        ...
        questions: [
            { 
                ...
                helperText: "", validators: [], options: [], rules: [], repeaterFieldData: [] 
            }, { 
                label: "Sent at", type: "input", 
                inputType: "text", name: "created_at", 
                helperText: "", validators: [], options: [], rules: [], repeaterFieldData: [] 
            }
        ]
    }
    ...
    ngOnInit() {
        this.activatedRoute.params.subscribe((params) => {
            if(params.id) {
                //TO-DO: Allow ability to get all request types
                this.authService.getAccessRequest(params.id).subscribe((data: any) => {
                    this.request = data;
                    console.log(data);
                })
            }
