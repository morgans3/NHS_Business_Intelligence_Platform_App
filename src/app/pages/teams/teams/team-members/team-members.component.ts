...
export class TeamMembersComponent implements OnInit, OnChanges {
  ...
  tokenDecoded: any;
  @Input() blnShowAdminButton: boolean = false;
  @Input() blnShowRemoveFromTeamButton: boolean = false;
  @Input() blnShowAddToTeamButton: boolean = false;
  @Input() blnShowRemoveAdminButton: boolean = false;
  @Input() config: any;
  @Input() oldConfig: any;
