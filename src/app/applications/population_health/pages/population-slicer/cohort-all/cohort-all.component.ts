...
export class CohortAllComponent implements OnInit, OnChanges {
  ...
  saveUpdate() {
    this.notificationService.question("Are you sure you wish to proceed with this action?", [
      {
        title: "Yes",
        value: true,
        color: "primary"
  ...
  removeCohort() {
    this.notificationService.question("Are you sure you want to delete this cohort?", [
      {
        title: "Yes",
        value: true,
        color: "primary"
