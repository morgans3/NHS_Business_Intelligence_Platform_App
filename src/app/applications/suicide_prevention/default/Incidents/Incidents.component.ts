...
export class IncidentsComponent implements OnInit {
  ...
  constructor(private router: Router, public store: Store, private notificationService: NotificationService, private storageService: StorageService, private changeDetectorRef: ChangeDetectorRef) {
