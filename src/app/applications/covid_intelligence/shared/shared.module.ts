...
@NgModule({
    ...
    declarations: [StatCardComponent, UserValidationComponent, VerifiyDialogComponent, ValidateDialogComponent],
    entryComponents: [VerifiyDialogComponent, ValidateDialogComponent],
    exports: [StatCardComponent, UserValidationComponent, VerifiyDialogComponent, ValidateDialogComponent],
})
