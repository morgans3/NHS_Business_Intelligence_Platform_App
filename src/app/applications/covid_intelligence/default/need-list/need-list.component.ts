...
export class NeedListComponent {
  ...
  response_variable = ["Asthma", "Coronary Heart Disease", "Congestive Heart Failure", "Cancer", "COPD", "Depression", "Diabetes", "Hypertension", "Atrial Fibrillation", "Chronic Kidney Disease", "Dementia", "Epilepsy", "Hypothyroid", "Mental Health", "Learning Disability", "Osteoporosis", "Peripheral Artery Disease", "Rheumatoid Arthritis", "Stroke/TIA", "Shielding Patients"];
  response_variableCopy: string[] = [];
  // Predictor variable array
  predictors = ["Age", "Age Band", "Sex", "Deprivation Decile", "Asthma", "Coronary Heart Disease", "Congestive Heart Failure", "Cancer", "COPD", "Depression", "Diabetes", "Hypertension", "Atrial Fibrillation", "Chronic Kidney Disease", "Dementia", "Epilepsy", "Hypothyroid", "Mental Health", "Learning Disability", "Osteoporosis", "Peripheral Artery Disease", "Rheumatoid Arthritis", "Stroke/TIA", "Shielding Patients"];
  ccg_list = [];
  cohort_array: any;
