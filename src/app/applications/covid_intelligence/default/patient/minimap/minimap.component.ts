...
export class MinimapComponent implements OnChanges {
    ...
    constructor(private apiService: APIService, private postcodeService: PostcodeService) {}
    ...
    bindHomeHTML() {
        ...
        if (this.person.ward_name || this.person.d_ward_name)
            output += "<span>Electoral Ward: " + (this.person.ward_name || this.person.d_ward_name) + "</span><br />";
        return output;
    }
    ...
    bindGPHTML() {
        let output = "";
        if (this.person.practice || this.person.d_practice)
            output += "<span>Practice: " + (this.person.practice || this.person.d_practice) + "</span><br />";
