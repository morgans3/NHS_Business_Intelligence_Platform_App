...
export class NSSSComponent implements OnInit {
    ...
    constructor(public store: Store, private apiService: APIService, private notificationService: NotificationService) {
    ...
    exportShieldingList(hasMFA: boolean) {
        ...
        const options = {
            ...
            headers: [
                ...
                "Contact Number (Texts)",
                "Contact Email",
                "Submission Date/Time",
                "UID Submission",
                "Are You Applying On Behalf Of Someone Else?",
                "Have You Received An NHS Letter?",
                "Do You Want Supermarket Deliveries?",
                "Do You Need Someone To Contact You About Local Support?",
                "Do You Have One Of The Listed Medical Conditions?",
        ...
        if (!hasMFA) {
            ...
            exportData = this.dataSource.data.map((d) => {
                return {
                    ...
                    are_you_applying_on_behalf_of_someone_else: d["are_you_applying_on_behalf_of_someone_else"]
                        ? d["are_you_applying_on_behalf_of_someone_else"]
                        : "",
                    have_you_received_an_nhs_letter: d["have_you_received_an_nhs_letter"] ? d["have_you_received_an_nhs_letter"] : "",
                    do_you_want_supermarket_deliveries: d["do_you_want_supermarket_deliveries"]
                        ? d["do_you_want_supermarket_deliveries"]
                        : "",
                    do_you_need_someone_to_contact_you_about_local_support: d["do_you_need_someone_to_contact_you_about_local_support"]
                        ? d["do_you_need_someone_to_contact_you_about_local_support"]
                        : "",
                    do_you_have_one_of_the_listed_medical_conditions: d["do_you_have_one_of_the_listed_medical_conditions"]
                        ? d["do_you_have_one_of_the_listed_medical_conditions"]
                        : "",
                    do_you_have_someone_to_go_shopping_for_you: d["do_you_have_someone_to_go_shopping_for_you"]
                        ? d["do_you_have_someone_to_go_shopping_for_you"]
                        : "",
